...
- **Built-ins** — `print(...)` for integers, booleans, and strings; `string(...)` to build an owned `String` from a literal; `len(...)` for `str` and `String`
...
Most recently, place lowering was unified. Reading and writing a location now
